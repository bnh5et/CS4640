...
public class browse extends HttpServlet {
	...
	public void PrintBody(PrintWriter out) {
		...
		for(String s : keys){
			...
			out.println("			 			<input class=\"form\" type=\"submit\" value=\"Update Game " + s + "\" name=\"btn\"> ");
			out.println("			 		</form>");
			out.println("			 	</td>");
			out.println("			 	<td align=\"center\">");
			out.println("			 		<form action=\"" + BrowseServlet + "\" method=\"post\">");
			out.println("			 			<input class=\"form\" type=\"submit\" value=\"Delete Game " + s + "\" name=\"btn\">");
			out.println("			 		</form>");
			out.println("			 	</td>");
			out.println("			 	<td align=\"center\">");
			out.println("			 		<form>");
			out.println("			 			<input class=\"form\" type=\"submit\" value=\"Play Game " + s + "\" name=\"btn\">");
			out.println("			 		</form>");
			out.println("			 	</td>");
			out.println("			 </tr>");
		}
